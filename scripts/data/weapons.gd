...
const WEAPONS := {
	...
	"thunder_tetsubo": {
		"weapon_id": "thunder_tetsubo",
		"name": "Thunder Tetsubo",
		"weapon_type": Constants.WeaponType.TETSUBO,
		"might": 15,
		"hit": 75,
		"crit": 10,
		...
		"min_range": 1,
		"max_range": 1,
		"description": "Crackles with storm energy on impact.",
	},
	...
	"iron_staff": {
		...
		"min_range": 1,
		"max_range": 1,
		"description": "A sturdy iron-tipped staff.",
	},
	"steel_staff": {
		"weapon_id": "steel_staff",
		"name": "Steel Staff",
		"weapon_type": Constants.WeaponType.STAFF,
		"might": 9,
		"hit": 78,
		...
		"min_range": 1,
		"max_range": 1,
		"description": "A reinforced steel fighting staff.",
	},
	"onmyou_orb": {
